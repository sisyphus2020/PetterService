...
namespace PatterService.Controllers
{
    public class CompaniesController : ApiController
    {
        ...
        public IQueryable<Company> GetCompanies(int page = 1)
        {
            var Companies = db.Companies.OrderBy(p => p.CompanyNo)
        ...
        {
            return db.Companies.Count(e => e.CompanyNo == id) > 0;
        }
    }
}