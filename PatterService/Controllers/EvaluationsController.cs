...
namespace PatterService.Controllers
{
    public class EvaluationsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> PostEvaluation(Evaluation evaluation)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = evaluation.EvaluationNo }, evaluation);
        }
        ...
        {
            return db.Evaluations.Count(e => e.EvaluationNo == id) > 0;
        }
    }
}